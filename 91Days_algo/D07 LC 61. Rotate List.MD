...
- 使用快慢指针fast & slow pointer.  find the splitting point.  slow pointing to 新的尾部. fast pointing to旧尾巴:  fast moves first while decreasing k, When k<=0 , slow begins to move
